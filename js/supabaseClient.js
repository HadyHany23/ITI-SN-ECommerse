...
const SUPABASE_SDK = window.supabase || window.supabaseJs;

const CURRENT_USER_KEY = 'currentUser';

if (!SUPABASE_URL || !SUPABASE_PUBLISHABLE_KEY || !SUPABASE_SDK?.createClient) {
  window.appDb = null;
  console.error(
    'Supabase is not initialized. Generate js/env.js from .env and ensure Supabase SDK script is loaded.'
  );
} else {
  const supabaseClient = SUPABASE_SDK.createClient(
    SUPABASE_URL,
